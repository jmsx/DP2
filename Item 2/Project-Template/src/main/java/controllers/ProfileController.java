...
public class ProfileController extends AbstractController {
	...
	public ModelAndView action1() {
		...
		quotes.add("Hay algo que ni siquiera Dios pudo negar a los hombres: la libertad -- Adolfo Suárez");
		quotes.add("The greatness of humanity is not in being human, but in being humane -- Mahatma Gandhi");
		quotes.add("Research is to see what everybody else has seen and think what nobody has ever thought -- Albert Szent-Györgyi");
		quotes.add("Cogito, ergo sum -- René Descartes");
		quotes.add("I've always been famous, it's just no one knew it yet -- Lady Gaga");
